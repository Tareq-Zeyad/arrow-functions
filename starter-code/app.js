...
// Its the object calling of the function scope. So an arrow function will use the value of this in the scope where it was defined.

// 2. What is "this" when joe.scopeArrow() is invoked?
//A very different behaviour, am not sure about it but its something with arrow functions is using lexical scope & a scope  is all the variables visible to a function where it is defined.

// 3. Explain why "this" is different when an arrow function is used.
// Arrow functions do not have a prototype property and they cannot be used with new. Its not useful to use arrow functions as constructors so that any (this) will refer to different keywords leads to different calling.